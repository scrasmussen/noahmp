...
! ----------------------------------------------------------------------
...
#ifdef NOAHMP_ACC_COLUMNS
       ResistanceMomBareGrd = 1.0e6
       ResistanceShBareGrd  = 1.0e6
       ResistanceLhBareGrd  = 1.0e6
       return
#else
    ...
    if ( IndIter == 1 ) then
       ...
       MoLengthBare     = -1.0 * FrictionVelBare*FrictionVelBare*FrictionVelBare / TMP1
